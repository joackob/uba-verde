...
const UbaVerdeGrid = () => {
  ...
  return (
    <Grid container spacing={0} style={{ height: '100vh', width: '100vw' }}>
      ...
      {isTabletOrBigger && <Grid item sm={1} style={{ backgroundColor: '#91a661' }} />}

      {/* Segunda fila */}
      <Grid item xs={4} sm={3} style={{ backgroundColor: '#dcde9f' }} />
      <Grid item xs={4} sm={4} style={{ backgroundColor: '#446129' }} />
      <Grid item xs={4} sm={4} style={{ backgroundColor: '#91a661' }} />
      {isTabletOrBigger && <Grid item sm={1} style={{ backgroundColor: '#D9D4A6' }} />}

      {/* Tercera fila */}
      <Grid item xs={4} sm={3} style={{ backgroundColor: '#446129' }} />
      <Grid item xs={4} sm={4} style={{ backgroundColor: '#91a661' }} />
      <Grid item xs={4} sm={4} style={{ backgroundColor: '#ffffff' }} />
      {isTabletOrBigger && <Grid item sm={1} style={{ backgroundColor: '#ffffff' }} />}

      {/* Cuarta fila: Logo y texto */}
      <Grid item xs={12} >
        <Box style={{ padding: '2vh' }} alignItems="center" sx = {{
           height: "100%",
           display: "flex",
      ...
      <Grid item xs={4} sm={4} style={{ backgroundColor: '#446129' }} />
      {isTabletOrBigger && <Grid item sm={1} style={{ backgroundColor: '#dcde9f' }} />}

      {/* Sexta fila */}
      <Grid item xs={4} sm={3} style={{ backgroundColor: '#91a661' }} />
      <Grid item xs={4} sm={4} style={{ backgroundColor: '#446129' }} />
      <Grid item xs={4} sm={4} style={{ backgroundColor: '#dcde9f' }} />
      {isTabletOrBigger && <Grid item sm={1} style={{ backgroundColor: '#A8B575' }} />}
